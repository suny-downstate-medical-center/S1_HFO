...
cfg.filename = 'IPSP_type8_gabaaVrev' + str(cfg.gabaVrev)  			# Set file output name
...
#8	0.75±0.32	8.30±2.20	0.25±0.130	706±405	21±9	I2-IE	BTC-DBC-BP:Excitatory
...
for ii in range(100):
    ...
    netParams.connParams['pre->post'+str(ii+1)] = { 
            ...
            'weight': 0.75, # weight[ii], # # synaptic weight 
            'synsPerConn': 15, 
            'delay': 0.05}       
